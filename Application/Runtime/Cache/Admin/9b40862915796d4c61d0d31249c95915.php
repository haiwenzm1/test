        ...
        editClick: function (e) {
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    html += '</div></div>';
                    html += '<div class="form-group"><label class="col-sm-2 control-label col-lg-2">类别</label><div class="col-lg-10">';
                    html += '<label class="checkbox-inline"><input type="radio" name="last" value="1" '+((data.info[0]['is_last']==1)?'checked="checked"':'')+'> 权限组</label>';
                    html += '<label class="checkbox-inline"><input type="radio" name="last" value="0" '+((data.info[0]['is_last']==0)?'checked="checked"':'')+'> 权限组分类</label>';
                    html += '</div></div>';
                    html += '<div class="form-group">';
